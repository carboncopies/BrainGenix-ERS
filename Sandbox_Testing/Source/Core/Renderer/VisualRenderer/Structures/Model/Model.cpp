...
std::vector<ERS_TEXTURE_OBJECT_2D> ERS_OBJECT_MODEL::LoadMaterialTextures(aiMaterial *Mat, aiTextureType Type, string TypeName) {

    std::vector<ERS_TEXTURE_OBJECT_2D> Textures;

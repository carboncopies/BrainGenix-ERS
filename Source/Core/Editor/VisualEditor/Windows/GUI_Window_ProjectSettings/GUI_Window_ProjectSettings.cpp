...
void Window_ProjectSettings::Draw() {
    ...
    if (Enabled_) {
        ...
        IsProjectProprietary = !ProjectUtils_->ProjectManager_->Project_.ProjectProprietary;
        ...
        ProjectUtils_->ProjectManager_->Project_.ProjectProprietary = ~IsProjectProprietary;

...
Window_SceneTree::Window_SceneTree(std::shared_ptr<ERS_CLASS_SceneManager> SceneManager, ERS_STRUCT_SystemUtils* SystemUtils, ERS_STRUCT_ProjectUtils* ProjectUtils) {

...
void Widget_RAMGraph::Draw() {
    ...
    TotalRAM_.push_back((long float)HWInfo.Dynamic_.PhysicalMemoryCapacity / 1073741824);
    UsedRAM_.push_back(((long float)HWInfo.Dynamic_.PhysicalMemoryCapacity - HWInfo.Dynamic_.PhysicalMemoryFree) / 1073741824);
    TotalSwap_.push_back((long float)HWInfo.Dynamic_.SwapCapacity / 1073741824);
    UsedSwap_.push_back(((long float)HWInfo.Dynamic_.SwapCapacity - HWInfo.Dynamic_.SwapFree) / 1073741824);

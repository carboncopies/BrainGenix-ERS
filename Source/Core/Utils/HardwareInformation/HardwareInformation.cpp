...
HardwareInformation::HardwareInformation(LoggerClass *Logger) {
    ...
    HardwareInfo_.Static_.KernelVersion = std::string(std::to_string(KernelInfo.major) + std::string('.') + std::to_string(KernelInfo.minor) + std::string('.') + std::to_string(KernelInfo.patch) + std::string(" Build ") + std::to_string(KernelInfo.build_number));

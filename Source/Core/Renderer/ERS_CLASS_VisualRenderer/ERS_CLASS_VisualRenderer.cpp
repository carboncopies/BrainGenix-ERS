...
void ERS_CLASS_VisualRenderer::CreateViewport(std::string ViewportName) {
    ...
    Viewport->LightIconRenderer = std::make_unique<ERS_CLASS_LightIconRenderer>(OpenGLDefaults_, SystemUtils_, Shaders_[16]); //Set TO Shader 19 For Billboard Shader, Temp. Disabled As It Doesn't Work ATM

...
struct ERS_STRUCT_Model {
    ...
    bool TexturesBeingLoaded; /**<Used to set if the system is already loading textures*/
    bool TexturesBeingPushed; /**<Used to set if the system is already pushing textures*/

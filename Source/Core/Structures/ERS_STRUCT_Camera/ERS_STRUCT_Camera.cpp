...
void ERS_STRUCT_Camera::Update() {
    ...
    glm::quat QuatRoll   = glm::angleAxis(glm::radians(Orientation_[2]), glm::vec3(0, 0, 1));
    glm::quat QuatYaw    = glm::angleAxis(glm::radians(Orientation_[1]), glm::vec3(0, 1, 0));
    glm::quat QuatPitch  = glm::angleAxis(glm::radians(Orientation_[0]), glm::vec3(1, 0, 0));

...
public:
     ...
     * @param ProjectLoader 
     */
    ERS_CLASS_ProjectManager(ERS_STRUCT_SystemUtils* SystemUtils, ERS_CLASS_ProjectLoader* ProjectLoader, std::shared_ptr<ERS_CLASS_ProjectWriter> ProjectWriter, ERS_CLASS_SceneManager* SceneManager, ERS_CLASS_SceneLoader* SceneLoader);

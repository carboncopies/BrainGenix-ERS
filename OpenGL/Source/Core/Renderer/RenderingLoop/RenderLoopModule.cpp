...
void MainRenderLoop(GLFWwindow* Window, LoggerClass Logger) {
    ...
    // -----------------------------------------------------------------------------
    unsigned int diffuseMap = LoadTexture("Assets/Textures/Container2/Texture.bmp", Logger);
    unsigned int specularMap = LoadTexture("Assets/Textures/Container2/Specular.bmp", Logger);
    unsigned int emissionMap = LoadTexture("Assets/Textures/Container2/Emission.jpg", Logger);

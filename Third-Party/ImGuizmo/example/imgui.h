...
namespace ImGui
{
    ...
    IMGUI_API bool          DragFloat3(const char* label, float v[3], float v_speed = 1.0f, float colors[9], float v_min = 0.0f, float v_max = 0.0f, const char* format = "%.3f", ImGuiSliderFlags flags = 0); // MODIFIED BY ERS DEV TEAM TO ALLOW FOR RGB COLORD DRAG FLOAT
